 ...
 *
 * This file implements the logging functionality for the ginger library
...
namespace ginger {
    ...
    auto make_file_logger() noexcept -> std::shared_ptr<spdlog::logger> {
        auto l = spdlog::basic_logger_mt("file_logger", "ginger.log");
     ...
     *
     * This function creates a file logger that writes to "ginger.log",
    ...
    void log_with_spdlog(const std::string& message) {
        ...
        spdlog::info("Ginger message: {}", message);
    }
