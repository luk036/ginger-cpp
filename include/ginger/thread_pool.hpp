...
namespace ginger {
    ...
    /**
     * @brief Convenience accessor returning a singleton thread pool.
     *
     * The pool uses hardware concurrency as the number of worker threads.
     * Use this in call sites that do not need to manage pool lifetime.
     *
     * @return Reference to the global thread_pool instance.
     */
    inline auto get_thread_pool() -> thread_pool& {
